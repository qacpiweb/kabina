...
{
    public partial class Ass_Audio_Form : Form
    {
        ...
        private void bExperStart_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(plik_wejsciowy.Instructions,"Instrukcja");
      ...
      private void Aso_Audio_Form_KeyDown(object sender, KeyEventArgs e)
      {
          switch (e.KeyCode)
          {
              case Keys.Enter:
